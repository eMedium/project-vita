...
export class Barbarian extends Player {
    ...
    initializeStats(): void {
        this.stats = {
            ...
            baseHealth: Barbarian.BASE_STATS.HEALTH,
            baseSpeed: Barbarian.BASE_STATS.SPEED,
            baseDamage: Barbarian.BASE_STATS.DAMAGE,
            
            // Current stats (start same as base)
            health: Barbarian.BASE_STATS.HEALTH,
            speed: Barbarian.BASE_STATS.SPEED,
            damage: Barbarian.BASE_STATS.DAMAGE,
